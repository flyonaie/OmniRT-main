...
using namespace aimrt::examples::cpp::pb_rpc::normal_rpc_sync_server_module;
...
int32_t main(int32_t argc, char** argv) {
  ...
  try {
    ...
    NormalRpcSyncServerModule normal_rpc_sync_server_module;
    std::cout << "&normal_rpc_sync_server_module: " << &normal_rpc_sync_server_module << std::endl;
    std::cout << "normal_rpc_sync_server_module.NativeHandle()->impl: " << normal_rpc_sync_server_module.NativeHandle()->impl << std::endl;
    std::cout << "normal_rpc_sync_server_module.NativeHandle(): " << normal_rpc_sync_server_module.NativeHandle() << std::endl;
      
    core.GetModuleManager().RegisterModule(normal_rpc_sync_server_module.NativeHandle());
