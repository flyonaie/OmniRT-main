...
class BufferOperator {
 public:
  ...
  void SetUint8(uint8_t n) {
    if (omnirt_unlikely(cur_ + sizeof(n) > end_)) {
  ...
  void SetBuffer(const char *data, size_t len) {
    if (omnirt_unlikely(cur_ + len > end_)) {
...
class ConstBufferOperator {
 public:
  ...
  uint8_t GetUint8() {
    if (omnirt_unlikely(cur_ + sizeof(uint8_t) > end_)) {
  ...
  uint16_t GetUint16() {
    if (omnirt_unlikely(cur_ + sizeof(uint16_t) > end_)) {
  ...
  uint32_t GetUint32() {
    if (omnirt_unlikely(cur_ + sizeof(uint32_t) > end_)) {
  ...
  uint64_t GetUint64() {
    if (omnirt_unlikely(cur_ + sizeof(uint64_t) > end_)) {
  ...
  std::string_view GetString(BufferLenType len_type = BufferLenType::kUInt64) {
    ...
    if (omnirt_unlikely(cur_ + str_len > end_)) {
