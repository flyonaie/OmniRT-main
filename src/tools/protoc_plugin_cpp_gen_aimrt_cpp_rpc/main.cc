...
{{namespace_begin}}
{{for service begin}}
class __attribute__((visibility("default"))) {{service_name}}SyncService : public aimrt::rpc::ServiceBase {
 public:
...
{{for service begin}}
class __attribute__((visibility("default"))) {{service_name}}AsyncService : public aimrt::rpc::ServiceBase {
 public:
...
{{for service begin}}
__attribute__((visibility("default"))) bool Register{{service_name}}ClientFunc(aimrt::rpc::RpcHandleRef rpc_handle_ref, std::string_view service_name);
__attribute__((visibility("default"))) bool Register{{service_name}}ClientFunc(aimrt::rpc::RpcHandleRef rpc_handle_ref);
{{service end}}

{{for service begin}}
class __attribute__((visibility("default"))) {{service_name}}SyncProxy : public aimrt::rpc::ProxyBase {
 public:
...
{{for service begin}}
class __attribute__((visibility("default"))) {{service_name}}AsyncProxy : public aimrt::rpc::ProxyBase {
 public:
...
{{for service begin}}
class __attribute__((visibility("default"))) {{service_name}}FutureProxy : public aimrt::rpc::ProxyBase {
 public:
