...
AimRTCore::AimRTCore()
    : logger_ptr_(std::make_shared<aimrt::common::util::LoggerWrapper>()) {
      std::cout << "AimRTCore--get_log_level_func: " << logger_ptr_->get_log_level_func() << std::endl;
...
void AimRTCore::Initialize(const Options& options) {
  ...
  std::cout << "AimRTCore--Initialize--get_log_level_func: " << logger_ptr_->get_log_level_func() << std::endl;
  ...
  YAML::Node main_thread_options_node = configurator_manager_.GetAimRTOptionsNode("main_thread");
  std::cout << "AimRTCore--Initialize--main_thread_options_node: " << main_thread_options_node << std::endl;
  main_thread_executor_.Initialize(main_thread_options_node);
  ...
  // Init log
  std::cout << "AimRTCore--Init log--get_log_level_func: " << logger_ptr_->get_log_level_func() << std::endl;
  AIMRT_INFO("AimRTCore--Init log--get_log_level_func: " );
  ...
  std::cout << "AimRTCore--Init log end--get_log_level_func: " << logger_ptr_->get_log_level_func() << std::endl;
  ...
  std::cout << " Init modules--get_log_level_func: " << logger_ptr_->get_log_level_func() << std::endl;
...
void AimRTCore::InitCoreProxy(const util::ModuleDetailInfo& info, module::CoreProxy& proxy) {
  ...
  proxy.SetModuleManager(module_manager_.GetModuleManagerProxy(info).NativeHandle());
#endif
}
