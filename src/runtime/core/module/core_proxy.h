...
class CoreProxy {
 public:
  ...
  void SetModuleManager(const aimrt_module_manager_base_t* ptr) {
    module_manager_ = ptr;
  }
 ...
 private:
  static aimrt_core_base_t GenBase(void* impl) {
    return aimrt_core_base_t{
        ...
        .module_manager = [](void* impl) -> const aimrt_module_manager_base_t* {
          return static_cast<CoreProxy*>(impl)->module_manager_;
        },
        .impl = impl};
  }
 ...
 private:
  ...
  const aimrt_module_manager_base_t* module_manager_;
